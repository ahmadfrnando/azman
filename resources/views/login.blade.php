        ...
        <div class="w-full lg:w-1/2 p-8">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" class="w-full p-3 mt-2 border border-gray-300 rounded-md" value="{{ old('email') }}" required>
                    @error('email')
                ...
                <button type="submit" class="w-full py-3 bg-blue-500 text-white rounded-md font-semibold hover:bg-blue-600 transition">Login</button>
