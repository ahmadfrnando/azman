...
<div class="w-64 bg-primary text-white flex flex-col d-flex h-full p-4">
    ...
    <nav class="flex flex-col space-y-4">
        ...
        <a href="{{ url('/user/umkm') }}" class="hover:bg-secondary p-2 rounded flex gap-2 font-semibold @yield('nav__item-user-umkm')"><x-heroicon-o-truck class="w-6 h-6"/> Produk UMKM</a>
