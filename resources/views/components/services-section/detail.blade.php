@props(['gambar' => 'images/1.jpeg', 'judul' => '' , 'pesan' => false,'deskripsi' => '', 'slug' => '', 'phone' => '08217772121'])
...
<div class="text-justify flex flex-col items-center py-6 px-10">
    ...
    <div class="w-fit rounded bg-secondary p-4 md:p-5 mb-4 flex justify-center" style="width: 100% !important;">
        <img src="{{ asset('storage/'.$gambar) }}" alt="{{ $slug }}" style="width: 100%; max-height: 450px !important; object-fit: cover;">
    </div>
