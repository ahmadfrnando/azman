...
<div class=" max-w-7xl mx-auto bg-white px-6 py-16 sm:py-20 lg:px-0 overflow-hidden lg:overflow-visible">
    <div class="mb-20 lg:max-w-4xl">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Destinasi Favorit di Tapanuli Selatan</h1>
        <p class="mt-4 text-xl leading-8 text-gray-500">Berikut adalah rekomendasi destinasi wisata favorit yang bisa kamu kunjungi di Tapanuli Selatan. Sudah siap untuk petualanganmu?</p>
    </div>
                ...
                <div class="mt-4 md:mt-0 lg:mx-auto lg:w-full lg:max-w-7xl">
                    <div class="lg:pr-4">
                        <div class="lg:max-w-md">
                            ...
                            <a href="#" class="rounded-md bg-secondary px-5 py-3 font-semibold text-white shadow-sm hover:bg-secondary/[0.8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Lihat Detail</a>
                        </div>
                    </div>
                </div>
